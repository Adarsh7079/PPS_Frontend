    ...
    AnnotationToolbar.prototype.createPropertyTools = function (shapeType) {
        ...
        if (shapeType !== "") {
            ...
            var propertyToolbar = new Tool({
                ...
                created: function () {
                    if (!isNullOrUndefined(_this.pdfViewer.annotationModule.textMarkupAnnotationModule) && _this.pdfViewer.annotationModule.textMarkupAnnotationModule.currentTextMarkupAnnotation) {
